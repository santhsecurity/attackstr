# Contributing to attackstr (santh-payloads)
...
To add a new payload generation grammar or strategy, implement the required trait in `src/` and update the TOML parser. Add a corresponding test in `tests/`.
